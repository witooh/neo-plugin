...
Read each sampled page's **source markdown** (`docs/api/…`) and its **staged storage** (`.api-doc-publish/storage/<page>.xml` or the `"storage"` in `.api-doc-publish/<page>.json`). Compare them.
