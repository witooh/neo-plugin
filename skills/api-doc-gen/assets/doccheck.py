#!/usr/bin/env python3
"""
doccheck.py — TRIPWIRE cross-checker for api-doc-gen output (docs/api/ vs Go code).
Zero install: pure Python 3 (stdlib only). Companion to the api-doc-gen skill's Step 4.

WHY THIS EXISTS
  api-doc-gen's old verify was a single-agent self-check: the same agent that wrote
