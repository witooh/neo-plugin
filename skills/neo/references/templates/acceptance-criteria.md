...
**Usecase Scope Rule:** 1 AC document = 1 usecase folder. See `../roles/business-analyst.md` § Determinism Rules (**Usecase Scope** + **Folder Organization**) for the full decision tree (when to append vs. when to create a new usecase folder, folder-naming smell patterns).
