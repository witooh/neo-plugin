...
| `docs/design/{usecase}/*.html` | `~/.kiro/skills/neo/references/` |
| `docs/design/system-design/*.html` | `~/.kiro/skills/neo/references/` |
...
*(The API spec is **not** in this sidebar — it lives in the separate global tree `docs/api/`, see `~/.kiro/skills/neo/references/templates/api-spec.md`.)*
